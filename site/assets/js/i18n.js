...
(function () {
    ...
    const translations = {
        en: {
            ...
            reviewerNote_body: 'QarzDaftar is an Android mobile application. There is no web login or browser-based dashboard — all actions happen inside the app on your device.<br>To get started, install from <a href="https://play.google.com/store/apps/details?id=uz.devior.qarzdaftar" target="_blank" rel="noopener">Google Play</a>, then sign in with Google and manage your data directly in the app.<br><br>Key points:<ul style="margin:8px 0; padding-left:18px;"><li>The app uses Google Sign-In to securely identify you and enable optional backups and shared ledgers.</li><li>Your financial data is stored locally on your device. Cloud backup (Google Drive) is fully optional and controlled by you.</li><li>We do not sell or share your personal data with third parties for advertising.</li></ul>For more details, see:<br>• <a href="./privacy/index.html" target="_blank">Privacy Policy</a><br>• <a href="./terms/index.html" target="_blank">Terms of Use</a><br>• <a href="./data-deletion/index.html" target="_blank">Data Deletion Request</a>',
        ...
        ru: {
            ...
            nav_howItWorks: "Как работает",
            nav_tutorials: "Обучение",
            nav_privacyPolicy: "Конфиденциальность",
            nav_termsOfUse: "Условия",
            ...
            reviewerNote_body: 'QarzDaftar — это мобильное Android-приложение. Веб-входа или панели в браузере нет — все действия выполняются внутри приложения на вашем устройстве.<br>Чтобы начать, установите приложение из <a href="https://play.google.com/store/apps/details?id=uz.devior.qarzdaftar" target="_blank" rel="noopener">Google Play</a>, войдите через Google и управляйте данными прямо в приложении.<br><br>Основные моменты:<ul style="margin:8px 0; padding-left:18px;"><li>Приложение использует вход через Google для безопасной идентификации, а также для опционального резервного копирования и общих журналов.</li><li>Ваши финансовые данные хранятся локально на устройстве. Резервное копирование в Google Drive полностью необязательно и управляется вами.</li><li>Мы не продаём и не передаём ваши персональные данные третьим лицам для рекламы.</li></ul>Подробнее:<br>• <a href="./privacy/index.html" target="_blank">Политика конфиденциальности</a><br>• <a href="./terms/index.html" target="_blank">Условия использования</a><br>• <a href="./data-deletion/index.html" target="_blank">Запрос на удаление данных</a>',
        ...
        uz: {
            ...
            nav_privacyPolicy: "Maxfiylik",
            nav_termsOfUse: "Shartlar",
            nav_dataDeletion: "Ma'lumotni o'chirish",
            ...
            reviewerNote_body: 'QarzDaftar — bu Android mobil ilova. Veb-kirish yoki brauzer paneli yo‘q — barcha harakatlar qurilmangizdagi ilova ichida amalga oshiriladi.<br>Boshlash uchun <a href="https://play.google.com/store/apps/details?id=uz.devior.qarzdaftar" target="_blank" rel="noopener">Google Play</a>’dan yuklab oling, Google orqali kiring va ma’lumotlarni to‘g‘ridan-to‘g‘ri ilovada boshqaring.<br><br>Muhim nuqtalar:<ul style="margin:8px 0; padding-left:18px;"><li>Ilova xavfsiz kirish, ixtiyoriy zaxira nusxalar va umumiy kitoblar uchun Google Sign-In dan foydalanadi.</li><li>Moliyaviy ma’lumotlaringiz qurilmangizda mahalliy saqlanadi. Google Drive’ga zaxira nusxa olish to‘liq ixtiyoriy va sizning boshqaruvingizda.</li><li>Shaxsiy ma’lumotlaringizni reklamalar uchun uchinchi shaxslarga sotmaymiz yoki almashmaymiz.</li></ul>Batafsil:<br>• <a href="./privacy/index.html" target="_blank">Maxfiylik siyosati</a><br>• <a href="./terms/index.html" target="_blank">Foydalanish shartlari</a><br>• <a href="./data-deletion/index.html" target="_blank">Ma’lumotlarni o‘chirish so‘rovi</a>',
    ...
    /* Apply translations to elements with data-i18n or data-i18n-html */
    function applyTranslations(lang) {
        document.documentElement.lang = lang;

        // Support both:
        // - [data-i18n] for plain text
        // - [data-i18n-html] for HTML content (e.g., reviewer note with links)
        const nodes = document.querySelectorAll('[data-i18n], [data-i18n-html]');
        nodes.forEach(function (el) {
            var keyAttr = el.hasAttribute('data-i18n') ? 'data-i18n' : 'data-i18n-html';
            ...
            // If element uses data-i18n-html or has that attribute, set innerHTML; else textContent.
    ...
    function addLanguageSwitcher() {
        ...
        LANGS.forEach(function (code) {
            ...
            btn.style.color = currentLang === code ? '#ffffff' : '#9ca3af';
